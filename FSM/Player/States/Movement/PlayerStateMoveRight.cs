...
{
    internal class PlayerStateMoveRight : PlayerMovementStates
    {
        public PlayerStateMoveRight(int type, GameObject gameObject) : base(type, gameObject)
        {
        }
        ...
        public override void Enter()
        {
            if (_gameObject is GameObjects.Moving.Player.Player player)
            {
                ...
                player.Texture = AssetManager.playerTextures[2];
            }
        }
